...
public class PlotPAR {
	...
	static Vector<String> par = new Vector<String>(); 
	...
	// String for influxdb.
	static String influxdb = "--input /home/autonaut/java_to_influx/par.csv --user autonaut --password ntnu_autonaut --dbname AUTONAUT --metricname par --fieldcolumns value";
    ...
    static void plot(IMCMessage message){
		...
		System.out.println("PAR record saved!");
		...
		System.out.println(par.size() + " " + date_csv);
		...
		if(plot)
		{
			...
			System.out.println(par.size() + " " + times.size());

			try (PrintWriter writer = new PrintWriter(new File("/home/autonaut/java_to_influx/par.csv"))) {
