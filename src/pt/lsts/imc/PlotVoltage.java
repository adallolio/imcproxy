...
public class PlotVoltage {
	...
	static Vector<String> voltage = new Vector<String>(); 
	...
	// String for influxdb.
	static String influxdb = "--input /home/autonaut/java_to_influx/voltage.csv --user autonaut --password ntnu_autonaut --dbname AUTONAUT --metricname voltage --fieldcolumns value";
    ...
    static void plot(IMCMessage message){
		...
		System.out.println(voltage.size() + " " + date_csv);
		...
		if(plot)
		{
			...
			try (PrintWriter writer = new PrintWriter(new File("/home/autonaut/java_to_influx/voltage.csv"))) {
